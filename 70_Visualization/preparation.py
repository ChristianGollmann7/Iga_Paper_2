...
def prepare_geometry(G: splinepy.BSpline,
    ...
    if use_gauss:
        ...
        collocation_interior, collocation_dirichlet, collocation_neumann, collocation_total = create_collocation_points(G, dirichlet_boundaries, neumann_boundaries, refinements=refinements, use_gauss=False)
