...
architecture = [1, 1]
base_model_results = f"results_1/metrics_{architecture}_r_8.yaml"
compare_model_results = f"results_3/physics/metrics_r_8.yaml"
...
fig.savefig(f"results_3/physics/error_plot_combined_simple_vs_hard_{architecture}.png",
            dpi=600,
            bbox_inches='tight',
            pad_inches=0.05)
...
number_training_samples = [1, 10, 100, 1000]
architecture = [1, 1]
base_model_results = f"results_2/metrics_{architecture}.yaml"
compare_model_results = f"results_3/supervised/metrics.yaml"
...
networks = [f"results_3/supervised/network_{architecture}_{i}.pth" for i in number_training_samples]
for network in networks:
    model = torch.load(network, weights_only=False)
    result_pinn = Pinn(model)
    val_error_max, val_error_mean = evaluate_validation_samples(result_pinn, dirichlet_boundaries, neumann_boundaries, validation_set, return_value='both')
...
plt.tight_layout(rect=[0, 0, 1, 0.99])
fig.savefig(f"results_3/supervised/error_plot_combined_simple_vs_hard_{architecture}.png",
            dpi=600,
            bbox_inches='tight',
            pad_inches=0.05)
