...
compare_model_results = f"results_2/metrics_{architecture}.yaml"
...
fig.savefig(f"results_2/error_plot_combined_{architecture}.svg",
            format="svg",
            bbox_inches='tight',
            pad_inches=0.05)
fig.savefig(f"results_2/error_plot_combined_{architecture}.png",
            format="png",
            dpi=600,
            bbox_inches='tight',
            pad_inches=0.05)
