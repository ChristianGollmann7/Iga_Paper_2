...
results_folder = "results_1_paper/"
...
with open(f"{results_folder}metrics_{architecture}_r_8.yaml") as f:
...
# Load the networks
networks = [f"{results_folder}network_{architecture}_r_8_{i}.pth" for i in number_training_samples]
