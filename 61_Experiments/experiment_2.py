...
training_set = "vanilla_training_set"
...
for architecture in architectures:
    ...
    for i in number_training_samples:
        saving_name = f"results_2/network_{architecture}_{i}"
    ...
    with open(f"results_2/metrics_{architecture}.yaml", "w", encoding="utf-8") as f:
