...
"""
Experiment 1
Train several multi_instance_networks with presampled geometries. Training data is recorded and saved to file.
"""
...
for architecture in architectures:
    for refinement in refinements:
        ...
        for i in number_training_samples:
            saving_name = f"results_1/network_{architecture}_r_{refinement}_{i}"
        ...
        with open(f"results_1/metrics_{architecture}_r_{refinement}.yaml", "w", encoding="utf-8") as f:
